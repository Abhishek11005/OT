...
*
*/
@Controller("MinorOTObservationController")
@RequestMapping("/module/OT/observation.form")
public class MinotOTObservationController {
	...
	public String main(Model model) {
		...
		return "/module/OT/minorOT/observation";
	}
